...
{
	internal class SG_ColorMatrix extends SG_DynamicMatrix
	{
		// Luminance values
		...
		public function SG_ColorMatrix()
		{
			super(5, 5);
			LoadIdentity();
		}
		...
		public function SetHueMatrix(angle:Number):void
		{
			...
			var baseMat:SG_DynamicMatrix = new SG_DynamicMatrix(3, 3);
			var cosBaseMat:SG_DynamicMatrix = new SG_DynamicMatrix(3, 3);
			var sinBaseMat:SG_DynamicMatrix = new SG_DynamicMatrix(3, 3);
