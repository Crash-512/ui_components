...
package smart.gui.data {
	 ...
	 * DataGrid, TileList, and ComboBox main.objects.
	 *
	 ...
	 */
	public class SG_DataChangeEvent extends Event {
		/**
		 ...
		 *     <tr><td><code>itemsOld</code></td><td>An array that lists the itemsOld that were changed.</td></tr>
		 ...
		 * 			changed.</td></tr>
		 *     <tr><td><code>itemsOld</code></td><td>An array that lists the itemsOld to be changed.</td></tr>
		 ...
		 *        this parameter.
		 *
		 * @param items A list of itemsOld that were changed.
		 * 
		 ...
		 *  @productversion Flash CS3
		 */
		public function SG_DataChangeEvent(eventType:String, changeType:String, items:Array, startIndex:int=-1, endIndex:int=-1):void {
			super(eventType);
		...
		/**
         * Gets an array that contains the changed itemsOld.
         *
         * @langversion 3.0
         * @playerversion Flash 9.0.28.0
		 *  
		...
		/**
		 * Gets the index of the first changed item in the array of itemsOld 
		 * that were changed.
         *
         * @see #endIndex
         *
		...
		/**
         * Gets the index of the last changed item in the array of itemsOld
		 * that were changed.
         *
         * @see #startIndex
         *
		...
		override public function clone():Event {
			return new SG_DataChangeEvent(type, _changeType, _items, _startIndex, _endIndex);
		}
	}
}